package cn.sowell.ddxyz.model.admin.pojo;
...
public class AdminUser implements UserDetails, UserIdentifier{
	...
	public boolean isAccountNonExpired() {
		return DdxyzConstants.VALUE_TRUE.equals(accountNonExpired);
	}

	@Override
	public boolean isAccountNonLocked() {
		return DdxyzConstants.VALUE_TRUE.equals(accountNonLocked);
	}

	@Override
	public boolean isCredentialsNonExpired() {
		return DdxyzConstants.VALUE_TRUE.equals(credentialsNonExpired);
	}

	@Override
	public boolean isEnabled() {
		return DdxyzConstants.VALUE_TRUE.equals(enabled);
	}
