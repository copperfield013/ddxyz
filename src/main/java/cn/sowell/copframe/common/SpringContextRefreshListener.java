...
public class SpringContextRefreshListener implements ApplicationListener<ContextRefreshedEvent>{
	...
	Logger logger = Logger.getLogger(SpringContextRefreshListener.class);
	...
	public void onApplicationEvent(ContextRefreshedEvent event) {
		...
		logger.info("初始化订单资源回收器");
		kanteenService.startOrderResourceRecoverer(true);
		logger.info("订单资源回收器初始化完成");
