...
function() {
    ...
    function e(t, n) {
        var s = [];
        return s = "string" == typeof t ? (n || document).querySelectorAll(t) : [t],
        e.extend(s, e.fn),
        s
    }
    function s(t, n) {
        ...
        s || (s = "pushbutton" + Math.random().toString().replace("0.", ""), this.ele.attr("id", s)),
        this.id = e("#" + s),
        this.init(n)
    }
    return e.extend = function() {
        ...
        e = !1,
        s = Array.prototype;
        return "boolean" == typeof n[0] && (e = s.shift.call(n)),
        t = s.shift.call(n),
        s.forEach.call(n,
        function(n) {
    ...
    e.fn = {
        each: function(t) {
            return Array.prototype.forEach.call(this || [], t),
            this
        },
        on: function(t, n) {
    ...
    s.prototype = {
        ...
        refresh: function(t) {
            t ? e.extend(this.options, t) : t = this.options,
            this.init(t)
        },
        ...
        createTpl: function() {
            ...
            Array.isArray(l) || (l = []);
            for (var h = l.length,
            c = '<div class="widget-ui-pushbutton-list" style="max-height:' + u.maxHeight + 'px;">'; i < h; i++) {
                if (t = l[i], n = t.cls || "", e = t.text || "", a = t.attr, s = "", "object" != typeof a || Array.isArray(a)) {
                    if (Array.isArray(a)) for (r = a.length, o = 0; o < r; o++) s += this.forInAttr(a[o])
        ...
        event: function() {
            ...
            function(t) {
                ...
                i = !1,
                t.index = t.target.tabIndex,
                t.data = s[t.index];
                if(e(o).hasClass('list-a')){
                	this.hide();
                }
                //"function" == typeof a ? (i = a(t), i && e(o).hasClass("list-a") || this.hide()) : this.hide()
            }.bind(this))
        },
        show: function() {
