...
document.onreadystatechange = function () {
    if (document.readyState === "interactive") {
        ...
        var sitePub = new Pushbutton('#sitebutton', {
            data: [{ text: '雷峰塔之巅' }, { text: '断桥之上' }, { text: '杭州大厦' }],
            // 点击回调 返回true 则不隐藏弹出框
        ...
        var timePub = new Pushbutton('#timebutton', {
            data: [{ text: '2016-01-01 10:30' }, { text: '2016-01-08 10:30' }, { text: '2016-01-01 16:30' }, { text: '2016-01-01 16:30' }, { text: '2016-01-01 16:30' }],
            // 点击回调 返回true 则不隐藏弹出框
            onClick: function onClick(e) {
                if (e.data) {
                    if (e.data.text) {
        ...
        var payPub = new Pushbutton('#paybutton', {
            data: [{ text: '当面支付' }, { text: '断桥之上' }, { text: '杭州大厦' }],
            // 点击回调 返回true 则不隐藏弹出框
            onClick: function onClick(e) {
                if (e.data) {
