...
import cn.sowell.copframe.utils.DateTimeUtil;
...
public class DateTimeUtilTest {
	...
	public void testGetTimeList() throws ParseException{
		String dateString1 ="Y2017,2018。M3,4,5。W3,4,5。T13,16,18。";
		@SuppressWarnings("rawtypes")
		List list1 = DateTimeUtil.getTimeList(dateString1);
		System.out.println("list1 size = " + list1.size());
		
		String dateString2 = "Y2017,2018。M3,4,5。W1,2,3。T13,16,18。";
		@SuppressWarnings("rawtypes")
		List list2 = DateTimeUtil.getTimeList(dateString2);
		System.out.println("list2 size = " + list2.size());
		
		String dateString3 = "Y2017,2018。M3,4,5。D1,2,3。T13,16,18。";
		@SuppressWarnings("rawtypes")
		List list3 = DateTimeUtil.getTimeList(dateString3);
		System.out.println("list3 size = " + list3.size());
		
		String dateString4 = "Y2017,2018。M3,4,5。D12,23,24。T13,16,18。";
		@SuppressWarnings("rawtypes")
		List list4 = DateTimeUtil.getTimeList(dateString4);
